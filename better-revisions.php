...
class WP_Better_Revisions {
    ...
    public function sl_wp_actions_and_filters( )
    {
        ...
        add_filter( '_wp_post_revision_field_' . $this->metaPrefix . 'post_author', array( $this, 'sl_filter_revision_field' ), 10, 3 );
        add_filter( '_wp_post_revision_field_' . $this->metaPrefix . 'post_parent', array( $this, 'sl_filter_revision_field' ), 10, 3 );
        add_filter( '_wp_post_revision_field_' . $this->metaPrefix . 'comment_status', array( $this, 'sl_filter_revision_field' ), 10, 3 );
        add_filter( '_wp_post_revision_field_' . $this->metaPrefix . 'ping_status', array( $this, 'sl_filter_revision_field' ), 10, 3 );
        add_filter( '_wp_post_revision_field_' . $this->metaPrefix . 'post_modified', array( $this, 'sl_filter_revision_field' ), 10, 3 );
        add_filter( '_wp_post_revision_field_' . $this->metaPrefix . 'post_modified_gmt', array( $this, 'sl_filter_revision_field' ), 10, 3 );
    }
    ...
    public function sl_restore_revision( $post_id, $revision_id )
    {
        ...
        $ok        = $wpdb->update( $wpdb->prefix . 'posts', $revisionData, array(
            'ID' => $post_id
        ) );
